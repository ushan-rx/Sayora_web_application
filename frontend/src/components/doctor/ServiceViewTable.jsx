...
<div className="flex items-center">
        <label>
          <input type="radio" name="status" value="active" checked={updatedBooking.active} onChange={handleRadioChange} />
          Active
        </label>
        <label>
          <input type="radio" name="status" value="inactive" checked={!updatedBooking.active} onChange={handleRadioChange} />
          Inactive
        </label>
      </div>
