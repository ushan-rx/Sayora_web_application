      ...
      <div>
        <div className="flex flex-col md:flex-row">
          <div className="bg-white md:w-3/5">
            ...
            <div className="flex-col mx-6 mt-6 border-t-4 border-l-4 h-[450px] border-slate-300 rounded-2xl shadow-md"></div>
          </div>
          <ScrollArea className="px-4 my-6 bg-white border border-slate-400 rounded-2xl md:w-1/4 h-[605px]">
            <div>
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                {/* Square Card 1 */}
                <div className="px-6 py-4 bg-[#089BAB] border border-gray-300 rounded-2xl hover:bg-[#4db7c2]">
                  <div className="flex justify-between">
                    <div>
