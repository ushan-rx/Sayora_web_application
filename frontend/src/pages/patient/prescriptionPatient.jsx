  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row">
                  ...
                  <div className="mb-4 px-6 py-4 border-2 border-[#089BAB] rounded-2xl">
                    <div>
                      ...
                      <div className="flex justify-between mt-6">
                        ...
                        <div className="flex flex-col">
                          <button className="px-4 py-2 mb-2 text-[#089BAB] border-2 border-[#089BAB] rounded-3xl hover:bg-[#089BAB] hover:text-white">
                            View
                          </button>
                          <button
                    ...
                    <div ref={componentRef}>
                      ...
                      <div className="mx-6 px-6 py-4 border-2 border-[#089BAB] rounded-2xl ">
                        <div>
                          ...
                          <div className="text-xl font-semibold">
                            <Separator className="mt-4 mb-28" />
        ...
        <div className="mr-6 bg-white border md:w-2/5 rounded-xl"></div>
      </div>
    </div>
  );
};
